...
<body>
    <div class="container">
        ...
        <img src="./images/wallpaper.jpeg" alt="Library" class="banner">
        <p>
                ...
                <?php if ($result->num_rows > 0): ?>
                    <ul>
                        ...
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <li><a
                                    href="book_details.php?id=<?php echo $row['id']; ?>"><?php echo "Title: " . htmlspecialchars($row['title']) . " | Author: " . htmlspecialchars($row['author']); ?></a>
                            </li>
                        <?php endwhile; ?>
                    </ul>
                <?php else: ?>
